  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.sidebar}>
        <span className={styles.adminHeader} style={{ paddingLeft: "20px" }}><strong>Admin</strong></span>

        <div role="button" className={styles.menu} onClick={() => handleMenuClick('home')}>
          <i className={`bi bi-house-door ${styles.bigIcon}`}></i>Home
        </div>

        <div role="button" className={styles.menu} onClick={() => handleMenuClick('history')}>
          <i className={`bi bi-inbox ${styles.bigIcon}`}></i>History
        </div>

        <div role="button" className={styles.menu}>
          <i className={`bi bi-arrow-repeat ${styles.bigIcon}`}></i>Switch to user
        </div>
      </div>
